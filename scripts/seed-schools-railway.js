...
const prisma = new PrismaClient({
  datasources: {
    db: {
      url: "postgresql://postgres:pJKqbavlJeeLApxBgHrVMMeAZGnVQUPO@gondola.proxy.rlwy.net:19477/railway"
    }
  }
})
...
async function seedSchools() {
  console.log('Seeding schools to Railway database...')
  ...
  console.log('Schools seeded successfully to Railway!')
